...
public final class AWSCConstants {
    ...
    public static final List<String> LAMBDA_FUNCTION_ARCHITECTURES = List.of("X86");
    public static final List<String> LAMBDA_FUNCTION_MEMORY_SIZE = List.of("1769MB");

    private AWSCConstants() {
    }
}
